...
New-AzureRmResourceGroupDeployment -Name HANADeployment -ResourceGroupName HANADeploymentRG `
  -TemplateUri https://raw.githubusercontent.com/antonioexactly/saphananew/master/azuredeploy-hsr.json `
...
az group deployment create \
    ...
    --template-uri "https://raw.githubusercontent.com/antonioexactly/saphananew/master/azuredeploy-hsr.json" \
...
Copy the contents from the azuredeploy.json [file](https://raw.githubusercontent.com/antonioexactly/saphananew/master/azuredeploy.json) and paste them into the template editor, click Save.
